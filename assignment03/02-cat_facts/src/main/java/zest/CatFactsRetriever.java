...
public class CatFactsRetriever {
    private final HttpUtil httpUtilObj;

    public CatFactsRetriever(HttpUtil httpUtil) {
        this.httpUtilObj = httpUtil;
    }
    ...
    public String retrieveRandom() throws IOException {
        String response = httpUtilObj.get("https://catfact.ninja/fact");
    ...
    public String retrieveLongest(int limit) throws IOException {
        ...
        String response = httpUtilObj.get("https://catfact.ninja/facts?limit=" + String.valueOf(limit));
